...
%                     fprintf("i:%d,j:%d,k:%d,l:%d", xk_i, xk_j,xt_i, xt_j);
                    ...
                    val = 0;
                    total_graph(xt_i, xt_j) = total_graph(xt_i, xt_j) + gradient_diff;
                    total_graph(xk_i, xk_j) = total_graph(xk_i, xk_j) + gradient_diff;
                    val = val + eval_triag_area_relative_to_point(xk_i, xk_j, total_graph, length);
